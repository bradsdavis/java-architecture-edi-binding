...
public class EDIReader {
	...
	public static <T> void parseEDISegmentOrSegmentGroup(EDIMessage ediMessage, T object, Iterator<Field> fieldIterator, Queue<String> lookAhead, LineIterator lineIterator)
	...
	public static String getSegmentTag(Field field, boolean inner) {
	...
	public static <T> void parseEDISegmentFields(EDIMessage ediMessage, Object segment, String line) throws IllegalAccessException, InvocationTargetException, ClassNotFoundException,
	...
	private static Class getEDISegmentOrGroupType(Field field) {
