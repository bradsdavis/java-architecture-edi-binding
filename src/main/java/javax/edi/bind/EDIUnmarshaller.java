...
public class EDIUnmarshaller {
	...
	protected static Queue<String> queueLinesForType(EDISegment segment, Queue<String> lookAhead, LineIterator lineIterator) {
	...
	protected static FieldMatch advanceToMatch(Iterator<Field> fieldIterator, String line) {
